<?php
    ...
    function Addtestimonials($request){
      ...
      $query = "INSERT INTO testimonials(date_created,testimonials_name,testimonials_desc,testimonials_image) VALUES (NOW(),'".Generic::preventSqlInjection($testimonials_name)."','".Generic::preventSqlInjection($testimonials_desc)."','$testimonials_photo')";
    ...
    */
    function Updatetestimonials($request){
		...
		$query = "update testimonials set date_updated = NOW(),testimonials_name = '".Generic::preventSqlInjection($testimonials_name)."',testimonials_desc = '".Generic::preventSqlInjection($testimonials_desc)."'
                   $cond where id = $id";
		$result = mysql_query($query);
		if($result){
			$target_path = "uploads/testimonials/";

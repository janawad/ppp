...
<!-------------------------------------------------------------------------->	
		...
		<title>Princess Pavillion | Admin-Panel</title>
		...
		<div class="wrapper">
			...
			<header class="main-header">
				...
				<a href="index.php" class="logo">
				  ...
				  <span class="logo-lg"><b>Princess Pavillion</b></span>
				</a>
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="<?php echo $announcement ?>">
							<a href="index.php?page=gallery/list-gallery">
								<i class="fa fa-pie-chart"></i>&nbsp; <span>Gallery</span>
							</a>
						</li>
						
						<li class="<?php echo $client ?>">
							<a href="index.php?page=client/list-client">
								<i class="fa fa-pie-chart"></i>&nbsp; <span>Client</span>
							</a>
						</li>
			...
			<footer class="main-footer">
				...
				<!-- Default to the left -->
				<strong>Copyright &copy; <script> document.write(new Date().getFullYear());</script> <a href="#" target="__blank">Princess Pavillion</a>.</strong> All rights reserved.
			</footer>
		</div>
		<!-- ./wrapper -->
